...
?>
<?php
	$_SESSION['pagina'] = 'presentation/cargo/cargo.php';
?>
...
$(document).ready(function(e) {
   ...
   // forms
    ...
    $('#btnNuevo').off('click').click(function(e) {
      $('#contenido').load('presentation/cargo/cargoReg.php');
    });
...
function mostrarDatos() {
	$('#datos').load('presentation/cargo/cargoList.php?buscargo='+encodeURIComponent($('#txtcargo').val()));
}
</script>
